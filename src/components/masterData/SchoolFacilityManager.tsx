...
import { FacilityIntegration } from './FacilityIntegration';
...
export const SchoolFacilityManager = () => {
  ...
  return (
    <Tabs defaultValue="manual" className="space-y-4">
      <TabsList>
        <TabsTrigger value="manual">Manajemen Manual</TabsTrigger>
        <TabsTrigger value="integration">Integrasi Inventaris</TabsTrigger>
      </TabsList>
